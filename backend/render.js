...
exports.renderHandler = async (event) => {
  ...
  if (!taskDefinition || !cluster || !subnets || !securityGroups) {
    throw new Error('TASK_DEFINITION, ECS_CLUSTER, SUBNETS, or SECURITY_GROUPS not set');
  }

  console.log(
    `Listing tasks: ${JSON.stringify({
      cluster,
